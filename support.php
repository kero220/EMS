...
<body>
  ...
  <div id="container" class="pb-40px">
    ...
    <form action="/submit-issue" method="post">
      ...
      <input type="file" id="attachment" placeholder="Attach a File (optional)" class="bg-blue-900 text-white font-bold rounded-2xl p-3 mx-auto w-4/6" name="attachment"><br><br>
