        ...
        <div class="content w-full">
            ...
            <header class="z-10">
                ...
                <div class="navbar flex items-center gap-4">
                    <img id='user_img' src='data:image/jpeg;base64," . <?php echo $_SESSION['image'] ?> . "' alt='User Image' class="w-10">
                ...
                <div id="container" class="m-auto mt-20 rounded-xl bg-gray-100 p-6 shadow-lg max-w-xl">
                    ...
                    <div id="wrapper">
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data" class="flex flex-col gap-4 h-full max-h-auto min-w-auto">
                            ...
                            <!-- Date Input -->
                            <div id="dateDiv">
                                <input disabled='<?php echo isset($GLOBALS['date']) ? $GLOBALS['date'] : false ?>' type="date" id="date" name="date"
